...
**Vitally Responsible** is a plugin to automatically replace image tags in WordPress content with a version of the [picturefill](https://github.com/scottjehl/picturefill) syntax.
